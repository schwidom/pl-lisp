...
struct parseTree * evalParseTree( struct parseTree * ptp)
{
 ...
 // Die Entscheidung sollte dem Entwickler ueberlassen werden zb durch Definition des Funktionstyps.
 ...
 // vor ihr definiert wurden. Dies koennte der Programmierer temporaer oder dauernd aendern,
 // indem er das Environment der Funktion nach belieben neu setzt.
 ...
 // vorbei, die die Funktion bezeichnet, in der wir uns gerade befinden, muss er 
